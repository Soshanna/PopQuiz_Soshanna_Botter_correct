...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/img/exitbutton.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/img/startbutton.png");
		types.push (lime.Assets.AssetType.IMAGE);
	...
	public static function main () {
		...
		config = {
			...
			file: "OfficialQuizGame",
			fps: 60,
			name: "PopQuiz_Soshanna_Botter",
			orientation: "",
			packageName: "PopQuiz_Soshanna_Botter",
			version: "1.0.0",
			windows: [
