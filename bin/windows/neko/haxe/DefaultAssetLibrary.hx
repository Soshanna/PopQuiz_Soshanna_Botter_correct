...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/img/startbutton.png", "assets/img/startbutton.png");
		...
		path.set ("assets/QuizGameDatabase.db", "assets/QuizGameDatabase.db");
		type.set ("assets/QuizGameDatabase.db", AssetType.BINARY);
